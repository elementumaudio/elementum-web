...
const ELEMENTUM_I18N = {
  ...
  es: {
    ...
    acerca:{
      ...
      title:"Acerca", tagline:"Elementos, desde cero.",
      ...
      p4:"No lo hacemos solos: Elementum nace de un grupo de amigos y colaboradores que comparten la misma idea — crear en conjunto, sumar lo que cada quien sabe hacer, y construir algo que ninguno haría igual por su cuenta.",
  ...
  en: {
    ...
    acerca:{
      ...
      p4:"We don't do it alone: Elementum grew out of a group of friends and collaborators who share the same idea — creating together, combining what each of us knows, and building something none of us could make quite the same way alone.",
  ...
  fr: {
    ...
    acerca:{
      ...
      p4:"Nous ne le faisons pas seuls : Elementum est né d'un groupe d'amis et de collaborateurs qui partagent la même idée — créer ensemble, additionner ce que chacun sait faire, et construire quelque chose qu'aucun de nous n'aurait pu faire seul.",
  ...
  de: {
    ...
    acerca:{
      ...
      p4:"Wir machen das nicht allein: Elementum ist aus einer Gruppe von Freunden und Mitstreitern entstanden, die dieselbe Idee teilen — gemeinsam erschaffen, das Können jedes Einzelnen zusammenbringen und etwas bauen, das keiner von uns allein genauso hinbekommen würde.",
  ...
  ja: {
    ...
    acerca:{
      ...
      p4:"私たちは一人ではありません。Elementumは同じ思いを持つ友人や協力者たちから生まれました — 共に創り、それぞれの得意なことを持ち寄り、一人では作れないものを一緒に築いていく。",
